...
x = 3L    # the L says x is a long integer
          # .Machine$sizeof.long tells how many bytes there are in a long integer
          # .Machine.integer.max gives the maximum integer value
y = 3
...
z = x + y
print(z)
is.integer(z)   # z is a double
is.double(z)

####    integer division  (throw away the remainder)
...
#####   integer remainder (modulo operator)
r = x %% y
print(r)

y*z + r    #  divisor times quotient plus remainder equals x
...
#       x %% 2  is 0 if x is an even number
#       x %% 3  is 0 if x is a multiple of 3
#       etc.
...
b = 0x7fffffff   # you can enter hexadecimal values
b
is.integer(b)

z = b + 1
z
is.integer(b)    # z cannot be repesented as an integer
